...
# class DeviceArrayProtocol(typing_extensions.Protocol):
#   """Pytype annotations for mypy.

#   Using `DeviceArray` or `_CppDeviceArray` does not work with mypy.
#   """
#   __array_priority__: int
#   _device: Optional[Device]
#   aval: core.ShapedArray
#   _lazy_expr: Optional[lazy.LazyExpr]
#   device_buffer: "DeviceArrayProtocol"
...
#   __cuda_array_interface__: Dict[Any, Any]

#   def copy_to_device(self, device: Device) -> "DeviceArrayProtocol":
#     pass

#   def block_until_ready(self) -> "DeviceArrayProtocol":
#     pass
...
DeviceArray: Type[DeviceArrayProtocol] = xc.DeviceArrayBase
_CppDeviceArray: Type[DeviceArrayProtocol] = xc.Buffer
...
class _DeviceArray(xc.DeviceArrayBase):
